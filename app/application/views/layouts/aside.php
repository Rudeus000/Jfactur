       ...
       <ul class="metismenu" id="side-menu">
        <?php $empresa = getDatosEmpresa(); ?>
         ...
         <?php if ($this->session->userdata('perfil') == 1) : ?>
           <li>
             <a href="javascript: void(0);"><i class=" fas fa-clipboard-list"></i><span> Catalogo </span> <span class="menu-arrow"></span></a>
         ...
         <?php if ($this->session->userdata('perfil') == 1 or 6) : ?>
           ...
           <li>
             <a href="javascript: void(0);"><i class="fas fa-boxes"></i></i><span class="float-right label bg-primary inline m-t-10">nuevo</span> <span>Almacén val.</span> <span class="menu-arrow"></span></a>
             <ul class="nav-second-level" aria-expanded="false">
               <!-- <li><a href="<?= base_url() ?>administrador/motivorecepcion"><i class="fas fa-dolly"></i>Motivos Recepcion</a></li>   -->
         ...
         <?php if ($this->session->userdata('perfil') == 1) : ?>
           <li>
             ...
             <ul class="nav-second-level" aria-expanded="false">
               ...
               <li><a href="<?= base_url('reportes/regventasanio/compras') ?>">Compras por año</a></li>
         ...
         <?php if ($this->session->userdata('perfil') == 1) : ?>
           ...
           <li>
             <a href="javascript: void(0);"><i class="fab fa-whmcs"></i><span class="float-right label bg-primary inline m-t-10">nuevo</span> <span> Configuracion </span> <span class="menu-arrow"></span></a>
             <ul class="nav-second-level" aria-expanded="false">
         ...
         <?php endif ?>
         <li>
           <a href="javascript: void(0);"><i class="ion ion-md-play-circle"></i><span> Tutoria y Soporte </span>
           </a>
           <ul class="nav-second-level" aria-expanded="false">
