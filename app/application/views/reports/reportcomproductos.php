    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="page-title-box">
              <!-- <h4 class="page-title float-left"><i class="far fa-money-bill-alt" aria-hidden="true"></i> Reportes Compras Productos </h4> -->
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
            <div class="card-header bg-success"><h3 class="my-0 text-white">Reporte general de productos comprados</h3></div>
              <div class="card-body table-responsive">
                        <fieldset>
                  <!-- <legend>Filtro</legend> -->
                  <form id="ReportproductosFormBusqueda" action="" method="post" autocomplete="off">
                    <div class="row">
                      <div class="col-md-3">
                      ...
                      <div class="col-md-2">
                        <button class="btn btn-success waves-effect waves-light" style="display:none"><i class="fa fa-search"></i> Buscar</button>
                      </div>
                    </div>
                  </form>
                </fieldset>
                ...
                <br>
                <div>
                  <table id="Tablereportproductos" class="table mb-0 table-striped table-condensed" cellspacing="0" width="100%">
                    <thead>
