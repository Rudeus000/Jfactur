    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
            <div class="card-header bg-success"><h3 class="my-0 text-white">Cierre mes </h3></div>
                ...
                <fieldset>
                  ...
                  <form id="FormKardexFisico" action="" method="post" autocomplete="off">
                    <div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
							  <button style="margin-top:27px" type="button" id="btncierre" class="btn btn-rounded btn-success">Cerrar Mes</button>
							  &nbsp;
							  <button style="margin-top:27px" type="button" id="btnconsulta" class="btn btn-rounded btn-success">Buscar</button>	
							</div>
						</div> 
					<div id="listado"></div>						
                    </div>
