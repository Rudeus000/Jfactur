        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box">
              <h4 class="page-title float-left"><i class="far fa-money-bill-alt" aria-hidden="true"></i> Reporte detalle ventas</h4>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body table-responsive">
                ...
                <br>
                <div>
                  <table id="Tablereportdetalleventas" class="table table-bordered table-condensed" cellspacing="0" width="100%">
                    <thead>
                      <tr>
