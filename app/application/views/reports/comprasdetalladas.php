    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="page-title-box">
              <!-- <h4 class="page-title float-left"><i class="far fa-money-bill-alt" aria-hidden="true"></i> Reportes Compras Detalladas </h4> -->
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
            <div class="card-header bg-success"><h3 class="my-0 text-white">Reporte de compras detalladas</h3></div>
              <div class="card-body table-responsive">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <button style="margin-top:27px" type="submit" class="btn btn-primary"><i class=" fas fa-search m-r-5" ></i>Filtrar</button>                                                            
                          <a style="margin-top:27px" id="ReporteComprasDetalladasExcel" href="#" class="btn btn-purple" target="_blank"><i class="far fa-file-excel"></i> EXCEL</a>
                ...
                <div>
                  <table id="TableReporteDetalladoCompras" class="table table-striped" cellspacing="0" width="100%">
                    <thead>
