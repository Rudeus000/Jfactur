          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header bg-success">
                <h3 class="my-0 text-white">REPORTE DE COMISIONES POR PRODUCTO</h3>
              </div>
              <div class="card-body table-responsive">
                <fieldset>
                  <legend>Filtro</legend>
                  <form id="ReportcomisionproductosFormBusqueda" action="" method="post" autocomplete="off">
                    <div class="row">
                      <div class="col-md-3">
                ...
                <br>
                <div>
                  <table id="Tablereportcomisionproductos" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                    <thead>
                      <tr class="bg-success text-white">
                        ...
                        <th style="text-align: center; width: 90px">Comision.</th>
                        <th style="text-align: center; width: 90px">T.comision</th>
