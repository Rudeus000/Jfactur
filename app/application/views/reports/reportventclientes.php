    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="page-title-box">
              <!-- <h4 class="page-title float-left"><i class="far fa-money-bill-alt" aria-hidden="true"></i> REPORTE DE VENTAS POR CLIENTE </h4> -->
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
            <div class="card-header bg-success"><h3 class="my-0 text-white">Reporte de ventas por cliente</h3></div>
              <div class="card-body table-responsive">
                        <fieldset>
                  <legend>Filtro</legend>
                  <form id="ReportventclienteFormBusqueda" action="" method="post" autocomplete="off">
                    <div class="row">
                      <div class="col-md-3">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <select name="estado" class="form-control">
                            ...
                            <option value="G">Registrado</option>
                ...
                <br>
                <div>
                  <table id="Tablereportventaclientes" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                    <thead>
