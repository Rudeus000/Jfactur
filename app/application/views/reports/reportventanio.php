    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
            <div class="card-header bg-success"><h3 class="my-0 text-white">GRAFICO DE VENTAS POR AÑO</h3></div>
              <div class="card-body table-responsive">
                <form id="FormFiltroReporteVentasAnio" action="">
                  <div class="row">
                    <div class="col-md-2">
