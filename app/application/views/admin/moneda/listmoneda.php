                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <!-- <h4 class="page-title float-left"> <i class="fas fa-cubes"></i> Moneda</h4> -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                 <div class="card">
                                 <div class="card-header bg-success"><h3 class="my-0 text-white">Administrar de monedas<a href="" class="btn btn-rounded btn-pink float-right" data-toggle="modal" data-target="#ModalAgregarMoneda"><i class="fa fa-plus m-r-5"></i>Agregar</a></h3></div>
                                  ...
                                  <!-- Vertical Steps Example -->
                                            <div class="row">
                                                ...
                                                <table id="TableMantenimientoMoneda" class="table  table-striped" cellspacing="0" width="100%" >
                                              
                                                        <div class="form-group col-md-6">                                          
                                                        <label class="col-form-label" style="display: block"><br></label>
                                                        <!-- <span class="input-group-btn" data-toggle="modal" data-target="#ModalAgregarMoneda" style="padding-top:35px;">
                        ...
                        <div class="modal-content">
                                                ...
                                                <input type="hidden" > 
                                                    <div class="modal-header bg-success">
                                                        <h4 class="custom-modal text-white"  ><i class="fas fa-donate m-r-5"></i>Agregar moneda</h4>
    ...
    <div id="ModalEditarMoneda" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="display: none;" aria-hidden="true">
                                                ...
                                                <input type="hidden" name="id" > 
                                                    <div class="modal-header">
                                                        <h4 class="custom-modal"  >Editar moneda</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <div class="row">
