    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
            <div class="card-header bg-success"><h3 class="my-0 text-white">Lista de ventas<a href="<?= base_url('administrador/regventas/agregar') ?>" class="btn btn-pink float-right"><i class="fa fa-plus m-r-5"></i>Vender</a></h3></div>
              <div class="card-body">
                <!-- <div class="row">
                  <div class="col-md-12">
...
<div id="ModalEnviarWhatsapp" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Enviar Documento a Whatsapp</h5>
      ...
      <div class="modal-body">
        ...
        <button id="generar-documento-whatsapp" class="btn btn-success btn-md btn-block"><i class="fa fa-hand-pointer"></i>	Generar Documento a Enviar</button>
      </div>
...
<div id="ModalEnviarEmail" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Enviar Documento a Email</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
