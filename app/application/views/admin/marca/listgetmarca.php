                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header bg-success">
                                    <h3 class="my-0 text-white">Lista de marcas<i class="spinner-grow text-pink float-right"></i> <button class="btn btn-pink waves-effect w-md waves-light float-right" data-toggle="modal" data-target="#ModalAgregarMarca"><i class="fa fa-plus m-r-5"></i>Agregar</button></h3>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="FormMarca" action="<?= base_url('administrador/regmarca/insertMarca') ?>" method="post" autocomplete="off">
                <input type="hidden">              
                <div class="card-header bg-success">
                    <h3 class="my-0 text-white">Agregar marca<i class="spinner-grow text-warning float-right"></i></h3>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="FormEditarMarca" action="<?= base_url('administrador/Regmarca/editMarca') ?>" method="post" autocomplete="off">
                ...
                <div class="card-header bg-success">
                    <h3 class="my-0 text-white">Editar marca<i class="spinner-grow text-danger float-right"></i></h3>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
