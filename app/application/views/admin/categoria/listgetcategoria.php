                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header bg-success">
                                    <h3 class="my-0 text-white">Lista de categorias<i class="spinner-grow text-primary float-right"></i></h3>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="FormCategoria" action="<?= base_url('administrador/regcategoria/agregarCategoria') ?>" method="post" autocomplete="off">
                <input type="hidden">
                <div class="card-header bg-success">
                    <h3 class="my-0 text-white">Agregar categoria<i class="spinner-grow text-warning float-right"></i></h3>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="FormEditarCategoria" action="<?= base_url('administrador/regcategoria/editCategoria') ?>" method="post" autocomplete="off">
                ...
                <div class="card-header bg-success">
                    <h3 class="my-0 text-white">Editar Informacion de Categoria<i class="spinner-grow text-danger float-right"></i></h3>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
