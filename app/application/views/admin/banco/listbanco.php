                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header bg-primary">
                                <h3 class="my-0 text-white">Administrar bancos<button class="btn btn-pink waves-effect w-md waves-light float-right" data-toggle="modal" data-target="#ModalAgregarBanco"><i class="fa fa-plus m-r-5"></i>Agregar</button></h3>
                            </div>
                                    ...
                                    <table id="TableBancoListado" class="table mb-0" cellspacing="0" width="100%">
                                        ...
                                        <thead>
                                            <tr class="bg-primary text-white">
                                                ...
                                                <th style="text-align: center;">Nro CCI</th>
                                                <th style="text-align: center;">Entidad F.</th>
...
<div id="ModalAgregarBanco" class="modal bs-example-modal-center"  role="dialog" aria-labelledby="mySmallModalLabel" style="display: none;" aria-hidden="true">
            ...
            <form id="FormAgregarBanco" action="<?= base_url('administrador/regbanco/agregarBanco') ?>" method="post" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Nombre de banco:</label>
                                <input type="text" name="name_ban" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
