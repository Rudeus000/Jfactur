                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header bg-success">
                                    <h3 class="my-0 text-white">Lista unidad medida<a href="" class="btn btn-rounded btn-pink float-right" data-toggle="modal" data-target="#ModalAgregarUmedida"><i class="fa fa-plus m-r-5"></i>Agregar</a></h3>
                                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="FormUmedida" action="<?= base_url('administrador/regunidad/insertUmedida') ?>" method="post" autocomplete="off">
                <input type="hidden">
                <div class="card-header bg-success">
                    <h3 class="my-0 text-white">Agregar unidad medida<i class="spinner-grow text-warning float-right"></i></h3>
                </diV>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="FormEditarUmedida" action="<?= base_url('administrador/regunidad/editUmedida') ?>" method="post" autocomplete="off">
                ...
                <div class="card-header bg-success">
                    <h3 class="my-0 text-white">AEditar unidad medida<i class="spinner-grow text-danger float-right"></i></h3>
                </diV>
                <div class="modal-body">
                    <div class="row">
