...
<script type="text/javascript" src="<?php echo base_url_app();?>assets/js/NotaAlmacen/FrmMntNotaValorizado.js?v=<?php echo rand(0,5000);?>"></script>
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                <div class="card-header bg-success"><h3 class="my-0 text-white">Nota almacén <a class="btn btn-rounded btn-pink float-right" id="btnnuevo" tabindex="0" aria-controls="datatable-buttons"><i class="fas fa-plus m-r-5"></i><span>Agregar</span></a> </h3></div>
                ...
                <div class="row">
					...
					<!--<div class="col-md-2">
						<div class="form-group">
							<label for="cod_almacen">Almacén</label>
							<select id="cbo_cod_almacen" class="form-control"></select>
						</div>
					</div>-->
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="hidden" id="t_tipo_nota" value="" />
						</div>
						<!--<div class="form-group">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<select id="cbo_serie_nota" onchange="javascript:FrmMntNotaUnid.ProxCorrelativoVal()" class="form-control"></select>
						</div>
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<input type="text" id="t_num_nota" readonly class="form-control" value="<?php echo ($update==1?$entity['Num_Nota']:''); ?>"  />
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
							<label for="num_nota">Moneda<span style="color:red;">*</span></label>
							<select id="cbo_moneda" class="form-control">
					...
					<div class="col-md-2">
						<div class="form-group">
							<label for="num_nota">Tipo Cambio<span style="color:red;">*</span></label>
							<input type="text" id="t_tipocambio" class="form-control"  />
						</div>
					</div>
				</div>
				<!--<div class="row">
				...
				<div class="row">
					...
					<!--<div class="col-md-3">
						<div class="form-group">
							<label for="fecha_nota">Generar boleta unidades</label>
							<input type="checkbox" class="form-control" id="chkunidades" name="chkunidades" value=""  />
						</div>
					</div>-->
				</div>
				<!--<div class="row">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="obs_nota">Observación</label>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<label for="cnro_lote">Costo</label>
							<input class="form-control" type="text" id="t_costo" value=""  />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
...
<?php if($update==1){
?>
FrmMntNotaUnid.listar_cbo_Serie_NotaVal('<?php echo trim($entity['Serie_Nota']); ?>');
...
<?php } else {
	?>
FrmMntNotaUnid.listar_cbo_Serie_NotaVal('');
