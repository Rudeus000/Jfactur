...
$row = 1;
	...
	->applyFromArray($styleBold);
	$objPHPExcel->getActiveSheet()
	->setCellValueByColumnAndRow(7,$row,'Pagos')
...
foreach ($datos as $d) {
	$objPHPExcel->getActiveSheet()
	->setCellValueByColumnAndRow(0,$row,$d->documento_comp.': '.$d->numdocumento_comp)
	->getStyleByColumnAndRow(0,$row)
	...
	->applyFromArray($styleNormal);
	$objPHPExcel->getActiveSheet()
	->setCellValueByColumnAndRow(2,$row,$d->fecvenc_comp)
	->getStyleByColumnAndRow(2,$row)
	->applyFromArray($styleNormal);
	...
	->applyFromArray($styleNormal);
	$objPHPExcel->getActiveSheet()
	->setCellValueByColumnAndRow(4,$row,number_format($d->saldo_comp, 2, '.', ','))
	->getStyleByColumnAndRow(4,$row)
	->applyFromArray($styleNormal);
	$objPHPExcel->getActiveSheet()
	...
	->applyFromArray($styleNormal);
	$objPHPExcel->getActiveSheet()
	->setCellValueByColumnAndRow(6,$row,number_format($d->saldo_comp - $d->abono, 2, '.', ','))
	->getStyleByColumnAndRow(6,$row)
	->applyFromArray($styleNormal);
	$objPHPExcel->getActiveSheet()
	...
	foreach ($d->pagos as $p) {
		$row++;
		$objPHPExcel->getActiveSheet()
		->setCellValueByColumnAndRow(7,$row,$p->fecha_pago)
		->getStyleByColumnAndRow(7,$row)
		->applyFromArray($styleNormal);
		$objPHPExcel->getActiveSheet()
		...
		->applyFromArray($styleNormal);
		$objPHPExcel->getActiveSheet()
		->setCellValueByColumnAndRow(9,$row,$p->monto_pago)
		->getStyleByColumnAndRow(9,$row)
		->applyFromArray($styleNormal);
	}
	$row++;
