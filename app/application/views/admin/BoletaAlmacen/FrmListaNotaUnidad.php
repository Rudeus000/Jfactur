		...
		<script type="text/javascript" src="<?php echo base_url_app();?>assets/js/BoletaAlmacen/FrmListaNotaUnidad.js?v=<?php echo rand(0,5000);?>"></script>
                ...
                <div class="content">
                    <div class="container-fluid">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                <div class="card-header bg-success"><h3 class="my-0 text-white">Lista de boletas almacen <a class="btn btn-rounded btn-pink float-right" id="btnnuevo" tabindex="0" aria-controls="datatable-buttons"><i class="fas fa-plus m-r-5"></i><span>Agregar</span></a> </h3></div>
