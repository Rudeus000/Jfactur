        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                        <div class="card-header bg-primary"><h3 class="my-0 text-white">Administrar tarjetas bancarias<button  class="btn btn-pink waves-effect w-md waves-light float-right" data-toggle="modal" data-target="#ModalAgregarTarjeta"><i class="fa fa-plus m-r-5"></i>Agregar</button></h3></div> 
  ...
  <div id="ModalAgregarTarjeta" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"  style="display: none;" aria-hidden="true">
                        ...
                        <div class="modal-content">
                                                ...
                                                <input type="hidden" > 
                                                    <div class="modal-header bg-primary">
                                                        <h4 class="custom-modal text-white"  >Agregar Tarjeta</h4>
    ...
    <div id="ModalEditarTarjeta" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="display: none;" aria-hidden="true">
                                                ...
                                                <input type="hidden" name="id" > 
                                                    <div class="modal-header bg-primary">
                                                        <h4 class="custom-modal text-white"  >Editar Tarjeta</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <div class="row">
