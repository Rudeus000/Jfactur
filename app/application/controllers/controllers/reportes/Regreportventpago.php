...
class Regreportventpago extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportventaspagos_model');
	}
    ...
    $this->load->view('reports/reportventapago',$data);    
    $this->load->view('layouts/footer');
	}

	public function jsonReportpagosventas()
	{
		...
		$data['punto'] = $punto;
		$data['estado'] = $estado;	
		$datos = $this->reportventaspagos_model->getreportventaspago($data);
