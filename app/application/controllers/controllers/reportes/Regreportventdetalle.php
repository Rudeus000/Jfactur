...
class Regreportventdetalle extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportventasdetalle_model');
	}
    ...
    $this->load->view('reports/reportventadetalle',$data);    
    $this->load->view('layouts/footer');
	}

	public function jsonReportventasdetalle()
	{
		...
		$data['estado'] = $estado;	
		$datos = $this->reportventasdetalle_model->getreportventasdetalle($data);
