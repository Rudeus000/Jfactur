...
class Regreportventproducto extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportventasproductos_model');
	}
    ...
    $this->load->view('reports/reportventproductos',$data);    
    $this->load->view('layouts/footer');
	}

	public function jsonReportventproductos()
	{
		$data['start'] = $this->input->get_post('start', true);
		$data['length'] = $this->input->get_post('length', true);
        $data['sEcho']  = $this->input->get_post('_', true);
        $columns= ['cod_producto','cod_producto'];
		...
		$datos = $this->reportventasproductos_model->getreportventproductos($data);
...
// Exportar a excel
	function reportVentaproductexcel(){
	$data['desde'] = $this->input->get('desde');
	$data['hasta'] = $this->input->get('hasta');
  	$data['datos'] = $this->reportventasproductos_model->getreportventproductexcel($data);
  	$this->load->view('reports/reporventaproductosexcel',$data);
  	}
