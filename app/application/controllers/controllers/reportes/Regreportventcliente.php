...
class Regreportventcliente extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportventasclientes_model');
	}
    ...
    $this->load->view('reports/reportventclientes');    
    $this->load->view('layouts/footer');
	}

	public function jsonReportventclientes()
	{
		$data['start'] = $this->input->get_post('start', true);
		$data['length'] = $this->input->get_post('length', true);
        $data['sEcho']  = $this->input->get_post('_', true);
        $columns= ['doc_cliente','doc_cliente'];
		...
		//}
		$data['estado'] = $estado;	
		$datos = $this->reportventasclientes_model->getreportventclientes($data);
