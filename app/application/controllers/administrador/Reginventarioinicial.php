...
class Reginventarioinicial extends CI_Controller
{
	...
	function reporteExcelSeries()
	{
		...
		// 	echo $d->cod_producto . " | " . $d->nomb_product . " | " . $d->serie_estado . " | " . $d->fecha_venta . "<br>";
		// 	exit();
		// }
	...
	{
		$this->db->select('p.*, nomb_almacen, serie_descripcion, ps.cod_vent AS codigo_venta, cod_comp, serie_estado, histcompstock_serie, fecha_registro, 
