...
class Regreportcotipagos extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportcotipagos_model');
	}
    ...
    $this->load->view('reports/reportcotipagos',$data);    
    $this->load->view('layouts/footer');
	}

	public function jsonReportcotizacion()
	{
		$data['start'] = $this->input->get_post('start', true);
		$data['length'] = $this->input->get_post('length', true);
        $data['sEcho']  = $this->input->get_post('_', true);
        $columns= ['fecha_cot','fecha_cot'];
		...
		$tb_cliente = $this->input->get_post('tb_cliente');
		...
		// if ($tb_cliente!='') {
			$data['tb_cliente'] = $tb_cliente;
		//}
		$data['pago_cot'] = $pago_cot;
		$data['moneda_cat'] = $moneda_cat;
	//	$data['tb_talonario']= $tb_talonario;
		$data['estado'] = $estado;	
		$datos = $this->reportcotipagos_model->getreportcotizacion($data);
