...
class Regreportcomproduct extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportcomproductos_model');
	}
    ...
    $this->load->view('reports/reportcomproductos',$data);    
    $this->load->view('layouts/footer');
	}

	public function jsonReportproductos()
	{
		$data['start'] = $this->input->get_post('start', true);
		$data['length'] = $this->input->get_post('length', true);
        $data['sEcho']  = $this->input->get_post('_', true);
        $columns= ['cod_producto','cod_producto','cod_producto','cod_producto'];
		...
		$datos = $this->reportcomproductos_model->getreportproductos($data);
