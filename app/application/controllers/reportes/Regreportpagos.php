...
class Regreportpagos extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportcompras_model');
	}
    ...
    $this->load->view('reports/reportpagos');    
    $this->load->view('layouts/footer');
	}

	public function jsonReportcompras()
	{
		$data['start'] = $this->input->get_post('start', true);
		$data['length'] = $this->input->get_post('length', true);
        $data['sEcho']  = $this->input->get_post('_', true);
        $columns= ['fecha_comp','fecha_comp','fecha_comp'];
		...
		$data['estado'] = $estado;	
		$datos = $this->reportcompras_model->getreportcompras($data);
