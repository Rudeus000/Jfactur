...
class Regreportcomision extends CI_Controller
{

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportecomision_model');
	}

	public function index()
	{
		$data['vendedores'] = $this->reportecomision_model->getVendedores();
		...
		$this->load->view('reports/reportcomisiones', $data);
		$this->load->view('layouts/footer');
	}

	public function jsonComision()
	{
		...
		$datos = $this->reportecomision_model->getreportcomisionproductos($data);
