...
class Regreportcotiproductos extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportcotiproductos_model');
	}
    ...
    $this->load->view('reports/reportcotiproductos',$data);    
    $this->load->view('layouts/footer');
	}

	public function jsonReportcotiproductos()
	{
		...
		$datos = $this->reportcotiproductos_model->getreportcotiproductos($data);
