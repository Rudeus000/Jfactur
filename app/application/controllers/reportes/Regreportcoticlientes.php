...
class Regreportcoticlientes extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('reportcoticlientes_model');
	}
    ...
    $this->load->view('reports/reportcoticlientes');    
    $this->load->view('layouts/footer');
	}

	public function jsonReportcoticlientes()
	{
		...
		$data['estado'] = $estado;	
		$datos = $this->reportcoticlientes_model->getreportcoticlientes($data);
