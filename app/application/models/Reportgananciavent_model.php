...
class Reportgananciavent_model extends CI_Model {

	function getreportgananciaproductos($data)
	{
  ...
  //        }
		...
		$result['precompras'] = $precompras;
		$result['ventcompras'] = $ventcompras;
		$result['ganancia'] = $ganancia;
		$row = [];
		foreach ($query->result() as $q) {
		
			$row[] = [$q->cod_producto,$q->nomb_product,$q->nomb_marca,$q->nomb_categoria,$q->nomb_unid,$q->cantidad,$q->compra,$q->costocomp,$q->precio,$q->total,$q->utilidad];
		}
    ...
    function getreportgananciaexcel($data){
