...
FrmListaNotaUnidad={ 
	Fill:function(){ 
			 $.ajax({
				 url:pathController+'/notavalorizado/fillallnotavalorizado',
				 type:'post',
				 dataType:'json',
				 data:{
	...
	NewReg:function(){ 
		 location.href=pathController+"/notavalorizado/New_notavalorizado/"; 
	},//fin NewReg
	Edit:function(id){ 
		 location.href=pathController+"/notaunidad/Findnotaunidad/"+id; 
	},//fin Edit
	Imprimir:function(id){
		location.href=pathController+"/notavalorizado/reportePdf/"+id;
	},
	Rmv:function(id){ 
