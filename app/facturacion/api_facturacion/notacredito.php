...
$resp['ruta_xml'] = 'archivos_xml_sunat/cpe_xml/' . $tipo . '/' . $array_emisor['ruc'] . '/' . $nombre_archivo . '.XML';
$resp['ruta_cdr'] = 'archivos_xml_sunat/cpe_xml/' . $tipo . '/' . $array_emisor['ruc'] . '/R-' . $nombre_archivo . '.XML';
...
function get_array_cabecera($data, $emisor)
{
	$cabecera = array(
		...
		'TOTAL_IGV_CABECERA' => $data['total_igv_cabecera'],
